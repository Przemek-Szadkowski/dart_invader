...
class Practice {
    ...
    resetTimer() {
        return`${Math.floor(PRACTICE_TIME / 600 >= 10 ? PRACTICE_TIME / 60 : '0' + PRACTICE_TIME / 60)}:${PRACTICE_TIME % 60 > 9 ? PRACTICE_TIME % 60 : '0' + PRACTICE_TIME % 60}`;
    }
