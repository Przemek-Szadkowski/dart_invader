...
const greenButtons = getElements(constans.GREEN_BUTTONS_CLASS);
const timer = getElement(constans.TIMER_CLASS);
const startButton = getElement(constans.START_BUTTON_CLASS);
const pauseButton = getElement(constans.PAUSE_BUTTON_CLASS);
const resetButton = getElement(constans.RESET_BUTTON_CLASS);
const historyButton = getElement(constans.HISTORY_BUTTON_CLASS);
const containerForBigNumber = getElement(constans.CONTAINER_FOR_BIG_NUMBER_CLASS);
const containerForSmallNumber = getElement(constans.CONTAINER_FOR_SMALL_NUMBER_CLASS);
const containerForDoubleNumber = getElement(constans.CONTAINER_FOR_DOUBLE_NUMBER_CLASS);
const containerForBullNumber = getElement(constans.CONTAINER_FOR_BULL_NUMBER_CLASS);
const containerForTripleNumber = getElement(constans.CONTAINER_FOR_TRIPLE_NUMBER_CLASS);
const modalContainer = getElement(constans.MODAL_CONTAINER_CLASS);
const historyModalContainer = getElement(constans.HISTORY_MODAL_CONTAINER_CLASS);
const modalReset = getElement(constans.MODAL_RESET_CLASS);
const historyResetButton = getElement(constans.HISTORY_RESET_BUTTON_CLASS);
const resultsTable = getElement(constans.RESULTS_TABLE_CLASS);
const hintContainer = getElement(constans.HINT_CONTAINER_CLASS);
const helpButton = getElement(constans.HELP_BUTTON_CLASS);
const nextButton = getElement(constans.NEXT_BUTTON_CLASS);
const textHintContainer = getElement(constans.TEXT_HINT_CONTAINER_CLASS);
const buttonsDiv = getElement(constans.BUTTONS_DIV_CLASS );
const panelDiv = getElement(constans.PANEL_DIV_CLASS);
