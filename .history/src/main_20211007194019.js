...
helpButton.addEventListener('click', () => {
    ...
    textHintContainer.insertAdjacentHTML('afterbegin', texts.hints[0]);
    helpButton.disabled = true;
...
nextButton.addEventListener('click', () => {
    ...
    for(const hint of texts.hints) {
        if(hint.name === 'eleventh') {
            helpButton.disabled = false;
        ...
        textHintContainer.insertAdjacentHTML('afterbegin', hint.text);
