...
const GREEN_BUTTONS_CLASS = '.dart';
const TIMER_CLASS = '.timer';
const START_BUTTON_CLASS = '.start';
const PAUSE_BUTTON_CLASS = '.pause';
const RESET_BUTTON_CLASS = '.reset_button';
const HISTORY_BUTTON_CLASS = '.history_button';
const CONTAINER_FOR_BIG_NUMBER_CLASS = '.bigNumber';
const CONTAINER_FOR_SMALL_NUMBER_CLASS = '.smallNumber';
const CONTAINER_FOR_DOUBLE_NUMBER_CLASS = '.double';
const CONTAINER_FOR_BULL_NUMBER_CLASS = '.bull';
const CONTAINER_FOR_TRIPLE_NUMBER_CLASS = '.triple';
const MODAL_CONTAINER_CLASS = '.modal_outer';
const HISTORY_MODAL_CONTAINER_CLASS = '.history_modal_outer';
const MODAL_RESET_CLASS = '.modal_reset';
const HISTORY_RESET_BUTTON_CLASS = '.history_reset';
const RESULTS_TABLE_CLASS = '.results';
const HINT_CONTAINER_CLASS = '.hint';
const HELP_BUTTON_CLASS = '.help';
const NEXT_BUTTON_CLASS = '.next';
const TEXT_HINT_CONTAINER_CLASS = '.text';
const BUTTONS_DIV_CLASS = '.buttons';
const PANEL_DIV_CLASS = '.panel'
