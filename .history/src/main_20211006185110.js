...
const modalInnerContainer = getElement(constants.MODAL_INNER_CONTAINER_CLASS);
...
//funkcje do osobnego modułu lub którejś klasy
...
startButton.addEventListener('click', () => {
    removingScoreClass();
    practice.startTimer(timer, modalContainer, modalInnerContainer);
...
modalReset.addEventListener('click', () => {
    ...
    modalInnerContainer.insertAdjacentHTML('afterbegin', resumeText);
})
...
//dodać w jakiś sposón numer wyświetlanego tekstu i na jego podstawie je zmieniać
